            ...
            <div className="relative z-10">
              ...
              <div className="mb-8 relative group px-1 md:px-2">
                ...
                <div className="relative flex gap-3 md:gap-5 overflow-x-auto pb-6 custom-scrollbar snap-x scroll-smooth">
                  {['2026-02-09 19.40.02.jpg', '2026-02-09 19.40.06.jpg', '2026-02-09 19.40.09.jpg', '2026-02-10 14.19.29.jpg', "2026-02-10 21.10.59.jpg", "2026-02-10 21.11.10.jpg","2026-02-10 21.12.42.jpg"].map((img, index) => (
