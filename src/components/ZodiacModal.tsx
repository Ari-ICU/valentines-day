    ...
    return (
        ...
        >
            <motion.div
                ...
                className="max-w-2xl w-full max-h-[90vh] overflow-y-auto bg-[#0f050a]/95 border border-primary/20 rounded-3xl p-6 md:p-12 shadow-[0_0_50px_rgba(255,77,109,0.15)] custom-scrollbar"
            >
